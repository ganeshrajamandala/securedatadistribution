     ...
     <center> <img src="images/title.png" align="middle"/> </center>
       ...
       <a href="HomePage.jsp">LogOut</a>
        <br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
          <center>  
           <h2> <marquee scrollamount="5" width="40">&lt;&lt;&lt;</marquee>Data Owner Profile<marquee scrollamount="5" direction="right" width="40">&gt;&gt;&gt;</marquee></h2>
          ...
          <p>
              ...
              String name=null,pass=null,email=null,mob=null,addr=null;
                ...
                ResultSet r = s.executeQuery("select * from adowner where name = '"+session.getAttribute("ownerUid").toString() +"'  ");
                if (r.next()){
