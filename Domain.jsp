...
<body background="images/bgimg3.jpg">
     <center> <img src="images/title.png" align="middle"/> </center>
        ...
        %>
          ...
          <center> <h3> <marquee scrollamount="5" width="40">&lt;&lt;&lt;</marquee>Domain Details<marquee scrollamount="5" direction="right" width="40">&gt;&gt;&gt;</marquee></h3>            
                            <form action="addD" method="post"><br/><br/>
                         
                 Domain Name  <input type="text" name="name"/> <br/><br/><br/><br/>
