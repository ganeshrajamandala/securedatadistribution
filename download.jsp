                            ...
                            <table  style="width:55%;" border="10">
                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        String query1 = "select * from filereq where u = '"+session.getAttribute("uID").toString() +"'";// "+" AND email = '"+mail+"' ";
                                ...
                                <tr style="font-family:verdana;font-size:12px;"> 
                                    ...
                                    <td> <font color="#804040"><a href="fileDChk.jsp?<%=host%>">Download</a></font> </td>
