...
<body background="images/bgimg3.jpg">
  ...
  <a href="AdminPage.jsp">Back</a> 
          ...
          <center> <h3> <marquee scrollamount="5" width="40">&lt;&lt;&lt;</marquee>Admin Profile<marquee scrollamount="5" direction="right" width="40">&gt;&gt;&gt;</marquee></h3>            
           <form action="apassUpdate" method="post">
              <%
              ...
              %>
                  ...
                  Old PassWord  <input type="text" name="pass" value="<%=pass%>" readonly/><br/><br/>
                  New password <input type="text" name="newp"/><br/><br/>
                  Conf. Password  <input type="text" name="conp"/><br/><br/>
